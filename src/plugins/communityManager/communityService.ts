...
export class CommunityManagerService extends Service {
  ...
  async getGreetingMessage(runtime: IAgentRuntime, userName: string, greetingMessage?: string) {
    ...
    //   prompt: basePrompt,
    // });
    const message = "I’d be happy to get you the information you need, but before I do, do you mind if I ask a few quick questions? That way, I can really understand what’s important and make sure I’m helping in the best way possible.";
